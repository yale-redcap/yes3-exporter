...
Users *with* project-design rights have the ability to create, modify and download exports.  Users *without* project-design rights to access what is created; they can view the export specifications and export data.

...
I started my career 50 years ago, as a mainly self-taught mainframe and minicomputer programmer for a U.S. Forest Service research lab in Connecticut. Through contacts I made at the Yale Computer Center - i.e. 1970s-style social networking - I took a job with the Yale School of Medicine, more or less where I stayed until I retired a few years ago. Despite post-graduate training and employment in biostatistics, I have always loved programming, and as soon as I could arrange it I left sample size calculations and *p<0.05* and moved back to the more predictable world of algorithms and data structures. According to Tracy Kidder's book *The Soul of a New Machine*, which if you haven't read you ought to, I should have expired as a programmer in 1992. Yet here I am. Every day there's a new puzzle to solve or self-induced castastrophe to fix, and it keeps me going.
...
My days of solo programming projects are over, and this is very good. Our team integrates highly experienced and skilled staff with post-graduate students enrolled in Yale's expanding informatics and data science programs. I don't know if this is particularly unusual at other institutions, but it really works. We often use the phrase "drinking from a firehose" to descibe the uncomfortable feeling of too much information too fast, but this is more like rafting down a river of software engineering technology. It's exciting and the direction finally seems right.

I am happy to be the mentee now, learning about new software frameworks and working within an integrated developer workflow, and taking halting steps toward actual retirement.
